...
label lab_floor_3:
    ...
    if tara == True:
        ...
        if rocky_dead == False:
            ...
            r "I didn't need permission but thanks,{w=.3} I guess"
...
label piece_puzzle_a:
    if piece_puzzle_a == True:
        ...
        "I insert USB Drive A into its respective place and a loud beep confirms I solve it!"
    else:
...
label locked_master_door:
    if butt_puzzle_complete == True:
        ...
        "This way is blocked off with a laser gate;{w=.3} it won't open unless I override it with some type of device around here..."
    jump pnc_loop
...
label butt_puzzle_intro:
    ...
    if butt_puzzle_complete == True:
        ...
        "This interface looks connected to the laser gate,{w=.3} hmm it's not working... {w=.3}I need to trigger something around here to turn this on."
        jump pnc_loop 
...
label keycard_slider:
    if keycard == False:
        ...
        play sound "audio/sfx/correct beep.ogg"
        "I slide the keycard through the device and a loud beep confirms it!"
    jump pnc_loop   
...
label pills:
        ...
        "There're some pills here on the table"
        play sound "audio/sfx/use.ogg"
        if vinnie_dead == False:
            ...
            menu pill_risk:
                ...
                "Use on me":
                    ...
                    if sage_health == 0:
                        ...
                        "I haphazardly walk out of the room..."
                ...
                "Use on Rocky" if rocky_dead == False:
                    ...
                    if rocky_health == 0:
                        ...
                        if norman_dead == False:
                            ...
                            "Norman starts mouth-to-mouth, he starts sobbing the longer he does it..."
                            "..."
                            pause 1.0
                            if insanity_level == 0:
                                "When Norman gets tired, I take his place."                            
                            ...
                            if insanity == 0:
                                ...
                                "The first person I killed was my own friend.{w=.3} He liked sacrificing his own wellbeing to protect his friends and this is how I repay it?"
                                "...{w=.3}I'm a monster..."
                                "What's the point of me being..." # alive, in this world
                                "..."
                                pause 1.0
...
label lab_note_2:
    ...
    show black with Dissolve(1.):
            alpha.6
    centered "{font=Dudu_Calligraphy.ttf}Frank Daniels- Junior Researcher- I was eleven when I promised my father I would find a cure for him. He died two months later. He would be so proud to see his boy working to prevent the same tragedy for others.{/font}"
    ...
    if examined_lab_note_2 == True:
        ...
        if norman_dead == False:
            ...
            n 3a"I don't know how to feel about them.{w=.3} They're big donors and associates to a lot of corporations,{w=.3} including Samsara.{w=.3} They...{w=.3} helped... {w=.3}fuel this..."
            ...
            n "They're never there for me when I need them,{w=.3} always busy somewhere else.{w=.3} Every time I need their help, they tell me to quit bothering them..."
            n 6"My whole life has been me acting alone,{w=.3} until I met all of you...{w=.3} my first friends..."
            menu:
            ...
            if tara == True:
                w 4"I haven't been with you for too long, but I can tell you've had quite an effect on people's lives..."
...
label lab_note_1:
    ...
    show black with Dissolve(1.):
            alpha.6
    centered "{font=Dudu_Calligraphy.ttf}Guinevere Zhara- Lab Technician- The patients from the hospital seem nervous. We told them it will be ok, it's all for the good of society, their efforts won't go to waste.{/font}"
    centered "{font=Dudu_Calligraphy.ttf}That seemed to have pacified them for now. We target people that would have died anyway, so what's the point if they die during our experimentation?{/font}"
    ...
    centered "{font=Dudu_Calligraphy.ttf}We're putting Strand #33 in the Samsara coffee now; we'll be judging the effects on the local population by seeing the hospital intake. Some were initially against it but the CEO made a passionate argument for it.{/font}"
    centered "{font=Dudu_Calligraphy.ttf}I for one, was all for it. Why can't these imbeciles understand drastic needs require drastic measures?{/font}"
    ...
    if rocky_dead == False and rocky_tantrum == False:
        ...
        if tara == True:
            ...
            w "Yeah, go ahead! Smash the thing that hundreds gave their lives for! {w=.3}I'm sure the data on there wasn't important or anything!"
            show r 3a at hop
            r "GAVE?!?!? More like stolen! {w=.3}Listen here! PEOPLE were INFECTED by this.{w=.3} Oh sorry! I guess daddy's little girl never had to worry about being hurt like the rest of us!!! Must be nice being born into the one percent!"
            ...
            if expose_samsara_together == True:
                "I touch Tara's shoulder and whisper about Rocky's mother; {w=.3}she's stunned in place for a moment before closing her eyes and starts solemnly nodding her head before recomposing herself."
            else:
                "I touch Tara's shoulder and whisper about Rocky's home life;{w=.3} she's stunned in place for a moment before closing her eyes and starts solemnly nodding her head before recomposing herself."
            ...
            w 8"We come from two different worlds... one good one bad,{w=.3} I- {w=.3}just didn't want the place where I came from...{w=.3} to be purely bad.{w=.3} Because,{w=.3} then what would that make me?"
            ...
            "Rocky continues punching the screen until it blacks out and his fist is a bloody mess."
            if norman_dead == False:
                n "..."
...
label lab_note_3:
    ...
    if keycard == True or examined_hakim == True:
        "This is who the item belongs to... {w=.3}seems like a real important guy... {w=.3}How much did he know was happening here? And could {w=.3}{i}he{/i}{w=.3} even stop it if he wanted to?"
...
label lab_note_4:
    ...
    centered "{font=Dudu_Calligraphy.ttf}Our families will be cured! Disease is a thing of the past! We don't care if we don't have permission from the CEO anymore! We're dispatching it to the chem trails ASAP! I'm saving you Grandma! The only downside is that it makes subjects near brain dead...{/font}"
...
label boss_battle:
    ...
    if vinnie_dead == False:
        ...
        s 6"What's revolting is how every entity {w=.3}doesn't see the glory being made here..."

        if rocky_dead == True:
            s 2"Your Maned Wolf friend would have loved the changes I would have made. {w=.3}The little people are always at the forefront of my mind.{w=.3} They are so {i}desperate{/i} which makes them easy for manipulation."
    ...
    if rocky_dead == False:
        ...
        if vinnie_dead == True:
            s 3"Are you making up for your lack of ferocity with trying to save the Opossum? {w=.3}They died because of you.{w=.3}{i} But I'm sure you know that already...{/i}"
        if norman_dead == True:
    ...
    if insanity_level >= 2 or vinnie_dead == True or norman_dead == True or rocky_dead == True:
        ...
        s 3"Ah, it's you the leader I presume? You've done {i}sooo{/i} well guiding everyone... {w=.3}Props to you I suppose..."
    ...
    "Ten zombies and one juggernaut zombie!"
...
label the_juggernaut:
        ...
        if tara == True:
            ...
            "Tara picked up some debris and is chucking at its face, knocking it off balance!"
...
label boss_aftermath:
    ...
    if tara == True:
        ...
        if norman_dead == False:
            ...
            w "No...{w=.3}I should be the one who is sorry...{w=.3} for what he's done to all you..."
        ...
        if norman_dead and rocky_dead and vinnie_dead and tara == False:
            ...
            "We all turned around and didn't even notice he was standing near the ledge."
        ...
        if norman_dead == False and tara == False:
            ...
            n "Better switch that off!{w=.3} I'm sure the ventilation system will get rid of it in due course!"                    
    ...
    if vinnie_dead == False and rocky_dead == False and norman_dead == False:
        ...
        n 2"Hahahaha!!!"
        p 8"You people are so weird!{w=.3} I love it!!!"
        if tara == True:
