label endings:
    ...
    if vinnie_dead == False or rocky_dead == False or norman_dead == False or tara == True:
        "We wave our hands in the air, {w=.3}signaling the copter to land..."
    if insanity_level >=1 and vinnie_dead == True and rocky_dead == True and norman_dead == True and tara == False:
        if norman_secret_death == True:
            ...
            n "Only focusing on yourself,{w=.3} letting your {w=.3}\"friends\"{w=.3} die so you would live? Your lack of compassion...{w=.5} is mortifying..."
            ...
            if norman_has_gun == True:
                "He dropped his gun; I don't need it though.{w=.3} As I have something else in mind..."
            ...
            if norman_affection >= 3:
                p 17"Aww what happened Norman?{w=.3} Not the type of wrestling you had in mind with me?{w=.3} Hahaha!"
                "He grimaces."
            if norman_has_gun == True:
                "Norman kept trying to crawl for the gun;{w=.3} I kept pulling him back by his ears and smashing his face into the ground."
            if sage_has_gun == True:
                "Norman kept trying to reach for the gun in my pocket, {w=.3}but I make sure to keep it juuuuuuusst out of reach..."
            "We kept fighting until we got to the ledge of the rooftop...{w=.3} he was closer, and I was a bit further away..."
        ...
        p 17"I've learned a great many things. Number one being that friendship is overrated."
    ...
    "..."
    "About a week has passed since then,{w=.3} the government called the national guard and quarantined the city and nearby areas.{w=.3} Fortunately, {w=.3}the virus was contained, {w=.3}and the rest of the country remains largely unaffected."
    if vinnie_dead == False and rocky_dead == False and norman_dead == False:
        ...
        if norman_affection >= 5:
            n "Why was I swooned by the homeless person!?!"
        n "Umm wait- {w=.3}how did you two even give birth to me????"
        ...
        if expose_samsara_together and expose_samsara_together_2 and expose_samsara_together_3:
            ...
            "The surviving board members of Samsara and its associates were held accountable in the court of law and arrested for crimes against society,{w=.3} thanks to us exposing them!"
    ...
    if vinnie_dead == True or norman_dead == True or rocky_dead == True:
        if vinnie_dead == False:
            "Vinnie never quite recovered from that day;{w=.3} they'd been isolated and hadn't been communicating as they usually do."
        ...
        if norman_dead == False:
                "Norman regularly meets up and starts the hangouts now, although, he's jumpier and fearful compared to back then."
