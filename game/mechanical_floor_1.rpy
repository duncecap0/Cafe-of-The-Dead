...
label mechanical_floor_1:
    ...
    if norman_affection == 0:
        n "I know you're not a hundred percent on board with this but,{w=.3} please trust in me..."
    ...
    "Here we are,{w=.3} the room is lined with pipes and exposed machinery, {w=.3}it's so cold and I can almost taste the dust in the air... {w=.3}Why would they not have windows here?"
    show n 8 with Dissolve(0.2)
    n "It's hard to see..."
...
#POINT AND CLICK LABELS
    ...
    label mech_desk:
        ...
        centered "{font=Dudu_Calligraphy.ttf}August 27- When I first started working here in Lucian's tower, I was but a wee lad o'seventeen that came here with nothin' but the clothes on his back.{/font}"
        ...
        centered "{font=Dudu_Calligraphy.ttf}Those kids even dismiss the fact that Samsara makes local hospitals gouge their prices, steal their resources, and give out their patient medical records to them. I wonder who made that seem like a hoax to all the common folk? I have no idea what they want with medical records of all things... {/font}"
        ...
        if rocky_dead == False:
            ...
            r "We're still working our asses off!{w=.3} He never got to enjoy retirement!{w=.3} My family and others sacrificed all for a CEO's fifty-second trip to the Bahamas!"
    ...
    label mech_right_hall_bed:
        ...
        centered "{font=Dudu_Calligraphy.ttf}Some... men in black body armor showed up, evacuated all civilians from the premises and set up a mile wide perimeter preventing anyone from seeing us... and then started just... beating us with riot batons and pepper spray.{/font}"
        ...
        centered "{font=Dudu_Calligraphy.ttf}They implemented some new system where employees are rewarded now for reporting any sign of dissatisfaction with their job and disciplined for not doing so... God, I still don't where some of my longtime friends are for refusing to surrender...{/font}"
        centered "{font=Dudu_Calligraphy.ttf}I'm scared to even write anymore... What if someone finds it? I have to get outta here...{/font}"
        hide black with Dissolve(0.2)
        play sound "audio/sfx/page turn.ogg"
        ...
        v "Yeah, pretty fucked up how the systems just stacked against lower wage workers, {w=.3}people who claim there isn't a class system are total stupidasses when shit like this happens..."
        scene mech bed with Dissolve(0.2)
        jump pnc_loop
    ...
    show black with Dissolve(1.):
        alpha.6
    centered "{font=Dudu_Calligraphy.ttf}October ?(I hope so) something...- Been here for who knows how long... They keep me cooped up here to set an example for the others...{/font}"
    ...
    centered "{font=Dudu_Calligraphy.ttf}The workers have been getting taken more and more frequently... It's just me and a skeleton crew now... this one kid... early twenties maybe? Named Lucas been scaring me...{/font}"
    centered "{font=Dudu_Calligraphy.ttf}He was a chef here... got called higher up to deliver private food to a V.I.P and I guess he saw something he wasn't supposed to see... forced him to be locked up here like me... I gave him my quarters while I choose to sleep on the desk...{/font}"
    ...
    centered "{font=Dudu_Calligraphy.ttf}Hasn't eaten in days... I tried to force him to, but he locked me out. I'm trying to break my way in there, but I don't know if I have the strength anymore. He honestly might be better off there. No one to force him to do his required hours.{/font}"
    ...
    if rocky_dead == False:
            ...
            if expose_samsara_together == True:
                r 10"We have already decided on exposing this place! We'll pick up where you left off Luis!"
...
label mechanical_floor_escape:
    ...
    p 7"Guys!{w=.3} The door and generator handle are broken, and the fan is blocking the vent out of here!{w=.3} Is there any way to turn it off from outside?!?"
        ...
        if expose_samsara_together == True:
            ...
            menu:
                ...
                "I tell Vinnie to stab the zombies" if vinnie_dead == False and vinnies_knife == True:
                    ...
                    $ renpy.notify("Vinnie's Knife has been removed from your inventory!")
                    $ vinnies_knife = False
                    "Vinnie charges forward and stabs the zombies! The knife is lost in the zombie's head!"
                    show r 2 at hop
                ...
                "I run away and abandon Rocky!":
                    if vinnie_dead == False and vinnie_has_gun == True:
                        ...
                        "Vinnie charges forward and gets lost in the horde in return... {w=.3}I hear chewing noises before Rocky yanks Vinnie out of there into their arms..."
                        show r 8 at hop
                        r "VINNIE NO!!! ARE YOU OK! SPEAK TO ME!! YOU'RE NOT DEAD! YOU'RE NOT!!!!"
                        show v 2 1 at offscreen_bottom with move
                        show r 8 at sink
                        v "I... {w=.3}really... {w=.3}l- {w=.3}l-{w=.3} liked our time together...{w=.3} please don-{w=.3} t be... {w=.3}worry ...{w=.3} haha...haaa {w=.3}*cough*"
                        ...
                        show r 7 at shiver
                        "Vinnie uses the last of their strength to shove Rocky away and gestures him to run to the elevator, Rocky hesitates but eventually does so."
                        show r 7 at shiver
                        pause 0.5
