...
default worker_key_CHAIR_ICON = False
...
label mechanical_floor_1:
    ...
    show black with Dissolve(1.):
        alpha.6
    "My heart beats as I march upwards. {w=.3}Would we be able to restore the power?{w=.3} Are the people here even alright?{w=.3} Can we really make it out of here?"
    if insanity_level >= 1:
        show static_anim with Dissolve(0.2)
        play audio "audio/sfx/static.ogg"
        "All the things I've said and done are running through my head."
        "Did I really mean that back there?{w=.3} It's strange,{w=.3} but I already feel..."
        "Different."
    ...
    if norman_affection == 0:
        n "I know you're not a hundred percent on board with this, but{w=.3} please trust me.."
        n "I'm just as afraid of you...{w=.3} I put on a front because I don't want the others to see how weak I really am..."
        n "Please...{w=.3} I- {w=.3}{i}WE-{/i} won't let anything bad happen to you...{w=.3} I promise..."
    else:
        ...
        n 8"I can't let them know that... {w=.3}I-{w=.3}I don't really know what I'm doing... Like, at all."
        n 5"Don't get it wrong though!{w=.3} I'm always glad to help someone out;{w=.3} like someone needs me... {w=.3}and hears me..."
        n 4a"But, {w=.3}it's nice to have someone like that for me too..."
    n 9"\"Your true family is the one who chooses and accepts one another\"...{w=.3} That's what you said right?"
    "Norman remembered my poem from class presentation..."
    if norman_affection >=1:
        p 2"..."
        p 1"Norman, {w=.3}of course I'll be there..."
        p 1"Don't worry, {w=.3}we {i}ALL{/i} got your back on this..."
        p 13"Just look how far you've gotten us already..."
        show n 9 at shiver
        n "...!"
        "Norman turns his head away sharply... {w=.3}I've never seen him this flustered before... {w=.3}Like he said,{w=.3} he always has to put on a perfect front..."
        "I swear Norman I'll ease your burdens... {w=.3}I'll let everyone else know so we can all be there for each other... {w=.3}In fact,{w=.3} we're already on the first step..."
        "Literally on the steps of stairs that is..."
    else:
        "..."
    ...
    "Here we are,{w=.3} the room is lined with pipes and exposed machinery. {w=.3}It's so cold; I can almost taste the dust in the air... {w=.3}Why would they not have windows in here?"
    show n 8 with Dissolve(0.2)
    n "It's hard to see..."
    ...
    menu:
        ...
        "Vinnie, Opossums have perfect night vision":
            ...
            v "Wow!{w=.3} Uh... {w=.3}o-{w=.3}ok not who I would choose but sure!{w=.3} I can dual wield my knife and gun! {w=.3}ENEMIES BEWARE!"
            if rocky_dead == False:
                show r 3 at left with Dissolve(0.2)
                r "Why not me?{w=.3} I DO NOT trust Vinnie with a gun..."
                v 13"I told you once that it's a part of Opossum culture to eat the smallest of their young and you believed me..."
                ...
                v 2 2"*sigh* Rocky with his awesome Maned Wolf night vision and sturdiness would've been a better candidate..."
            jump gun_check
        ...
        "Rocky, Maned wolves are nocturnal hunters" if rocky_dead == False:
            ...
            v 5"*sigh*{w=.3} Guess it's ok... {w=.3}I'm scared of guns..."
            jump gun_check
...
label gun_check:
    ...
    if norman_has_gun == False:
        n 13"Here! {w=.2}Just flick here to release the safety. {w=.3}Remember to breathe slowly to aim for the head better.{w=.2} And press here to shoot!"
...
label mech_hallway_right:
    ...
    label mech_ladder:
        if  worker_key_collect == True:
            ...
            p 1"Hmm, {w=.3}I'm the smallest so my weight shouldn't mess with the half-built platform as much."
            ...
            if rocky_dead == False:
                if insanity_level >= 1:
                    ...
                    "I throw the crowbar down to Rocky as an idea hits me."
                    "This is a stupid idea, but worth a shot..."
                    p 13"Hey! {w=.3}Rocko!{w=.3} Catch {i}THIS!{/i}"
                    with hpunch
                    show r 4a with Dissolve(0.2)
                    r "What?{w=.3} Oh!{w=.3} OOF!"
                    "I jumped off the raised platform straight into Rocky's arms." 
                    r 3a"What the hell made you do that!?!?"
                    p 15"...{w=.3}Hmm, intrusive thoughts?"
                    show v 2 4 at right with Dissolve(0.2)
                    v "HAHAHAHAHAHA! THAT's HI-LAAAAARIOUS! JUST STAY IN ROCKY'S ARMS LIKE THAT! {w=.3}YOU LOOK LIKE YOU COULD BE HIS NEWBORN OR SOMETHING HAHAHAHA!"
                    if norman_affection >= 1:
                        show n 9 at left with Dissolve(0.2)
                        n "Haaaaa... {w=.3}Yeeaaahh..."
                ...
                if norman_affection >= 2:
                    "Hmmm, I wonder if {i}he{/i} could catch me..."
                    p "Geronimo!"
                    with hpunch
                    ...
                    "Norman looks flustered as ever when our eyes lock."
                    "I accidentally found myself pinning him when I use my arms to prop myself up."
                    n "...!"
                    ...
                    "I throw the crowbar down to Vinnie and Norman who try to catch it."
                    "I descend the ladder and pick up the crowbar."
        else:
...
#POINT AND CLICK LABELS
    ...
    label mech_crowbar:
        ...
        p 1"That crowbar up there would be great at smashing stuff..."
        if rocky_dead == False:
    ...
    label hvac:
        if examined_HVAC_machine == True:
            ...
            if rocky_dead == False and examined_HVAC_machine == False:
                ...
                show r 11 with Dissolve(0.2)
                r "This here is an HVAC, stands for heating, ventilation, and air conditioning. {w=.3}Used to work on them during some odd jobs..."
                r "Looks like it's not on right now...{w=.3} I don't know what that means for the long term, but for now we should be fine."
                show v 18 at left with Dissolve(0.2)
                v "Looks like your blue collar background has finally come to use!"
    ...
    label mech_desk:
        ...
        centered "{font=Dudu_Calligraphy.ttf}When I first started working here in Lucian's tower. I was but a wee lad o'seventeen that came here with nothin' but the clothes on his back.{/font}"
        centered "{font=Dudu_Calligraphy.ttf}The younger workers nowadays don't even know the original name! They just assumin' they always owned the place.{/font}"
        centered "{font=Dudu_Calligraphy.ttf}Samsara made this fine building that kickstarted beginning businesses into just another one of their extravagant advertisements!{/font}"
        centered "{font=Dudu_Calligraphy.ttf}Those kids even dismiss the fact that Samsara makes local hospitals gouge their prices, steal their resources, and give out their patient medical records to them.{/font}" 
        centered "{font=Dudu_Calligraphy.ttf}I wonder who made that seem like a hoax to all the common folk? I have no idea what they would want with medical records of all things... {/font}"
        centered "{font=Dudu_Calligraphy.ttf}The company is all sorts of wrong if they could do that and get away with it. They must have some typa deal with the government to let them do that...{/font}"
        centered "{font=Dudu_Calligraphy.ttf}They bring in the wrong crowds now... Before it was fresh-faced people who wanted to change the world for the better! Now it something 'bout \"biotech\" or whateva the hell they call it.{/font}"
        centered "{font=Dudu_Calligraphy.ttf}Sounds like a load of horseshit from me! YEAH YOU HEARD ME CORPORATE!!!{/font}"
        centered "{font=Dudu_Calligraphy.ttf}They had us expand the tower immensely for their more private businesses when they first bought the place out; had me sign an NDA and everything!{/font}"
        centered "{font=Dudu_Calligraphy.ttf}Didn't let us know what exactly the floors were for but, damn do they take a helluva lot electricity.{/font}"
        centered "{font=Dudu_Calligraphy.ttf}Those bastards took the money required to power them out of our paychecks! Not to mention they treat us like trash! I've been working here for forty-seven damn years!{/font}"
        centered "{font=Dudu_Calligraphy.ttf}Like hell am I gonna let them get away with this! I been starting a union with us workers... I'll teach them to mess with us...{/font}"
        hide black with Dissolve(0.2)
        play sound "audio/sfx/page turn.ogg"
        ...
        if rocky_dead == False:
            ...
            r "This is horrible,{w=.3} just fucking disgusting. {w=.3}My MOTHER has been forced into paying for those ridiculous prices!"
            r "I've sacrificed my entire LIFE into paying them!{w=.3} I've never been able to enjoy affording something because the guilt of my mom not being able to kills me."
            r 8"My dad worked my entire childhood just to keep her alive!{w=.3} Imagine that!{w=.3} Being forced to burn money to keep your loved one trapped in a fucking chamber where they DIE if you can't pay."
            r "No free time for us,{w=.3} no family trips, no nice clothing.{w=.3} Barely enough food to have energy to work!"
            r "We're still working our asses off!{w=.3} He never got to enjoy retirement!{w=.3} My family sacrificed everything for some CEO's fifty-second trip to the Bahamas!"
            ...
            menu:
                "Now's your chance to fix it" if insanity_level == 0:
                    ...
                    r 3"Huh?"
                    p 1"Well,{w=.3} the business is literally going under Armageddon... {w=.3}So what better chance then now to expose them!"
                    p 4"We could find evidence of their wrongdoings while going through the building! There are definitely people who want payback!"
                ...
                "Let's keep searching":
                    r 1"..."
                    r 3"Fine..."
                    r 3a"{w=.3}I hope every person who allowed this was devoured alive by those zombies..."
                
            v 12"Rocky...{w=.3} I'm so sorry... {w=.3}It's my fault for...{w=.3} making you care for my immature ass..."
            ...
            v 12"Ahh the wonders of a capitalist empire...{w=.3} We should be so thankful!{w=.3} I wonder what Rock would have thought of this?"
            v "His family struggled with affording healthcare..."
        hide v with Dissolve(0.2)
        show n 3a at center with move

        if rocky_dead == False:
            n 3a"I never knew how deep Rocky's money problems went...{w=.3} Vinnie knows him better than I do."
        else:
            n 3a"I never knew how deep Rocky's money problems went...{w=.3} Vinnie knew him better than I did."

        n 8"They were childhood friends you know...{w=.3} They had some type of falling out and didn't meet again 'til college."
        n "I was the one who convinced Rocky to reunite with them when we first met."
        if rocky_dead == False:
            n "I don't think Vinnie and Rocky have been that honest with each other in a while..."
            n 1 "I'm glad they have each other in their lives, {w=.3}they work well together, right?"
            show n at hop
            n 16 "I'm not saying as a couple or anything!{w=.3} I just meant! {w=.3}Y'know they're good friends is all..."
        else:
            n 8"They worked so well together... {w=.3}I'm glad Rocky at least got to meet them again before this all happened. {w=.3}They belonged together..."
        ...
        menu:
            ...
            "Only true friends think like you do":
                ...
                p 2"Thank you.{w=.3} Sometimes It's just that I feel like an outsider here..."
    ...
    label mech_left_hall_jacket:
        ...
        "..."
        "I find a key in one of the pockets!"
        $ worker_key_collect = True
        $ worker_key_CHAIR_ICON = True
        p 4"Guys look!"
        if rocky_dead == False:
            ...
            n "Impressive! {w=.3}How did you know about that?"
            r "Used to work in a warehouse and they had me lock up all sorts of stuff similar to this..."
        else:
            show v 12 with Dissolve(0.2)
            v "Hmm, probably a padlock key... {w=.3}You could tell from my years' worth of stealing shit..."
    ...
    label mech_right_hall_bed:
        "I pick up a loose paper scrap from the mattress."
        $ worker_journal_2_collect = True
        window hide diss
        play sound "audio/sfx/page turn.ogg"
        show black with Dissolve(1.):
                alpha.6
        centered "{font=Dudu_Calligraphy.ttf}LUIS- Well, the union idea was a complete failure. The posse I gathered up marched straight to the head office demanding a raise.{/font}"
        centered "{font=Dudu_Calligraphy.ttf}When we listed off all our demands we were met with a full minute of deafening silence.{/font}" 
        centered "{font=Dudu_Calligraphy.ttf}Then they try to trick us, thinkin' I'm some starry-eyed youngin', with their \"Thank you for being honest with us, your concerns will be met accordingly\" B.S.!{/font}"
        ...
        centered "{font=Dudu_Calligraphy.ttf}Some... Men in black body armor showed up, evacuated all civilians from the premises and set up a mile wide perimeter preventing anyone from seeing us...{/font}"
        centered "{font=Dudu_Calligraphy.ttf}And then started just... Beating us with riot gear.{/font}"
        centered "{font=Dudu_Calligraphy.ttf}Even when we surrendered, they just kept going. I blacked out and when I woke up, I was in a bed. Some person in a suit said that I was under law to stay in these quarters.{/font}"
        centered "{font=Dudu_Calligraphy.ttf}I'm restricted to this building for the foreseeable future.{/font}"
        centered "{font=Dudu_Calligraphy.ttf}They implemented some new system where employees are rewarded now for reporting any sign of dissatisfaction with their job. We get disciplined for not doing so...{/font}"
        centered "{font=Dudu_Calligraphy.ttf}God, I still don't know where some of my longtime friends are for refusing to surrender...{/font}"
        centered "{font=Dudu_Calligraphy.ttf}I'm scared to even write anymore... What if someone finds this? I have to get outta here...{/font}"
        hide black with Dissolve(0.2)
        play sound "audio/sfx/page turn.ogg"
        #$ renpy.notify("Worker's Journal Entry #2 has been added to Notes!")
        if rocky_dead == False:
            show r 2 with Dissolve(0.2)
            r "How could they treat them like that?!?"
        show v 2 at right with Dissolve(0.2)
        v "Yeah, pretty fucked up how the systems just stacked against them. {w=.3}People who claim there isn't a class system are total stupidasses when shit like this happens..."
        scene mech bed with Dissolve(0.2)
        jump pnc_loop
    ...
    if rocky_dead == False:
        show r 1 with Dissolve(0.2)
        r "This is the elevator.{w=.3}It won't open until the power is back on..."
        hide r with Dissolve(0.2)
    else:
    ...
    if norman_affection >= 1:
        ...
        p 7"...!"
        p 14"OUR nerd..."
        "I'm pretty sure Norman was out of earshot for that one... {w=.3}Too busy guiding himself with the walls..."
    else:
        p 13"He's our nerd..."
    ...
    p 1"Hmm, {w=.3}true..."
    "I step forward and start rummaging through the body's pockets..."
    if insanity_level >= 1:
        show static_anim with Dissolve(0.2)
        play audio "audio/sfx/static.ogg"
        camera:
    ...
    show black with Dissolve(1.):
        alpha.6
    centered "{font=Dudu_Calligraphy.ttf}Been here for who knows how long... They keep me cooped up here to set an example for the others...{/font}"
    centered "{font=Dudu_Calligraphy.ttf}Conditions only got worse. It's a dog-eat-dog world out here now. Men selling out their friend for a raise.{/font}"
    centered "{font=Dudu_Calligraphy.ttf}Never thought I'd see the day...{/font}"
    centered "{font=Dudu_Calligraphy.ttf}The kids here turned from desperate for a job to piranha overnight...{/font}"
    centered "{font=Dudu_Calligraphy.ttf}Never thought I'd miss all of them being a smartass until now.{/font}"
    centered "{font=Dudu_Calligraphy.ttf}The workers have been getting taken more and more frequently... It's just me and a skeleton crew now...{/font}"
    centered "{font=Dudu_Calligraphy.ttf}This one kid- Early twenties maybe? Named Lucas been scaring me...{/font}"
    centered "{font=Dudu_Calligraphy.ttf}He was a chef here. Got called higher up to deliver private food to a V.I.P and I guess he saw something he wasn't supposed to see...{/font}"
    centered "{font=Dudu_Calligraphy.ttf}Forced him to be locked up here like me. I gave him my quarters while I chose to sleep on the desk...{/font}"
    centered "{font=Dudu_Calligraphy.ttf}He keeps ranting and raving about some monster. They must'a knocked his head up real bad to do cause that.{/font}"
    centered "{font=Dudu_Calligraphy.ttf}He locked himself in the electric generator... Said monsters can't get him there...{/font}"
    centered "{font=Dudu_Calligraphy.ttf}Hasn't eaten in days... I tried to force him to, but he locked me out. I'm trying to break my way in there, but I don't know if I have the strength anymore.{/font}"
    centered "{font=Dudu_Calligraphy.ttf}He honestly might be better off there. No one to force him to do his required hours.{/font}"
    centered "{font=Dudu_Calligraphy.ttf}I can't feel my fingers as much as I used to. It gets hard to write and spell sometimes. My coordination has been completely off... If I don't die from corporate it'd be from withering away.{/font}"
    centered "{font=Dudu_Calligraphy.ttf}I'm gonna save us kid. Ol' Luis will get ya outta here Lucas! And everyone else too, you're just being forced to...{/font}"
    hide black with Dissolve(0.2)
    play sound "audio/sfx/page turn.ogg"
    #$ renpy.notify("Worker's Journal Entry #3 has been added to Notes!")
    "..."
    "Norman approaches the body closer and notices something..."
    ...
    if rocky_dead == False:
            ...
            if expose_samsara_together == True:
                r 10"We've already decided on exposing this place! We'll pick up where you left off Luis!"
            v 6"Big thankies Luis!~{w=.3} I will make you famous so the world will remember your name!"
    ...
    pause 1.0
    "I peek through the door's shattered window to see a decomposing corpse."
    "It looks like they're resting in front of the generator..."
    ...
    if rocky_dead == False:
        #show r 2 with Dissolve(0.2)
        r "[pov] is small... {w=.3}BUT NOT THAT SMALL! {w=.3}Sorry buddy, but you won't be able to squeeze through the window!"
    ...
    if rocky_dead == False and crowbar_collected == True:
        ...
        "Rocky tries smashing the door open,{w=.3} but it won't budge..."
        r 8"*huff* {w=.3}*huff*"
        #show n 1 at left with Dissolve(0.2)
        n "Don't worry Rocky! It was a good effort!"
    elif rocky_dead == True and crowbar_collected == True:
        play sound "audio/sfx/metal.ogg"
        "I attempt to use the crowbar,{w=.3} but it's no use..."
        #show n 1 at left with Dissolve(0.2)
    ...
    label mech_vent:
        p 1"This vent must be the alternative path the note was talking about."

        menu:
            "Let's try to break it open!" if crowbar_collected == True or expose_samsara_together == True:
                pass
            "Let's keep looking around the floor":
                jump pnc_loop

        show v 16 at right with Dissolve(0.2)
        v "Ok cool, but how exactly {i}do{/i} we get in?"
        ...
        if rocky_dead == False:
            ...
            if expose_samsara_together == True:
                ...
                if crowbar_collected == True:
                    "Rocky enthusiastically crowbars the vent in."
                else:
                    "Rocky enthusiastically kicks the vent in."
                ...
                if insanity_level >= 1:
                    ...
                    play sound "audio/sfx/metal.ogg"
                    p 13"Your mom is waiting for us!{w=.3} She's chilling in her room just knowing that Rocky the great is on his way!"
                    ...
                    n 7"Hmm,{w=.3} I {i}could{/i} mention how you thought Vinni-"
                ...
                "We need to get this vent open. It's the only way through the door..."
                scene mech room 2 with Dissolve(0.2)
                jump pnc_loop
            ...
            if crowbar_collected == True:
                ...
                p 14"Unph!"
                play sound "audio/sfx/metal.ogg"
                "Vinnie and Norman take turns with me in trying to bash it open.{w=.3} It takes a while, but eventually we do."
                jump mechanical_floor_escape
            else:
                "We need to get this vent open. It's the only way through the door..."
                scene mech room 2 with Dissolve(0.2)
...
label mechanical_floor_escape:
    ...
    "I make my way through the vent.{w=.3} Avoiding the massive fan blades in the way. Good thing it's not on."
    scene electric generator with Dissolve(0.2)
    pause 1.0
    "The body in this cramped space elicits a foul odor... {w=.3}I guess Lucas never got out of here..."
    if insanity_level == 0:
        ...
        camera:
            reset
    "...? {w=.3}On closer examination Lucas's corpse has a massive hole in it? If we thought he shot Luis... Then did he shoot himself right after?"
    "If that's the case...{w=.3}Where's his gun...?"
    n "IS EVERYTHING GOOD IN THERE [pov!u]!?!?"
    p 4"Yeah! It's safe,{w=.3} just real musty!"
    ...
    with hpunch
    "The switch handle broke off when I shifted it. {w=.3}At least the power is on now."
    "Permanently."
    "I can feel the walls vibrate as the building itself feels like it's booting up."
    v "THE LIGHTS ARE ON!!! {w=.3}{i}I CAN SEE CLEARLY NOW!~{/i}"
    n "Ahh, much better!"
    ...
    "Stomping and groaning echo throughout the floor like the precursor to an avalanche."
    if rocky_dead == False:
        r "What the hell is that?!?!"
    n "Oh no, they must have heard the generator starting up!"
    if rocky_dead == False:
        v "More like because of numbnuts over here fucking around with the vent cover!"
        r "You were motivating me to dipshit!"
    "I try to open the door from the inside but-"
    "The door handle is broken!"
    with vpunch
    "Perhaps I could use the vent?"
    "I try to crawl into the vent, but see that the fan's blades are spinning."
    "I exit, and try to put the switch handle back into the electric generator in an attempt to fix it..."
    play sound "audio/sfx/cock.ogg"
    queue sound "audio/sfx/cock.ogg"
    queue sound "audio/sfx/cock.ogg"
    "It won't go in!"
    with vpunch
    p 7"Guys!{w=.3} The door and generator handle are broken, and the fan is blocking the vent out of here!"
    p "Is there any way to turn it off from outside!?!?"
    ...
    label norman_cant_find_fan:
            ...
            $ addNormhealth(-1) 
            "On his way,{w=.3} I hear a loud yelp and zombie shriek!" with hpunch
            n "Ow!{w=.3} It wasn't in there [pov]!"
            "Norman's voice sounds hoarse. He must've gotten hurt..."
            jump guide_norman 
    ...
    scene vent with Dissolve(0.2)
    play sound "audio/sfx/vent.ogg"
    "I hear the fan stop whirring and immediately make my exit!"
    ...
    "On my way out, I see Vinnie being cornered by a group of zombies!"
    queue sound "audio/sfx/Zombie_04.ogg"
        ...
        menu:
            "I run away and abandon Vinnie":
                ...
                if rocky_dead == False and rocky_has_gun == True:
                    ...
                    hide r 
                    hide v
                    "Rocky valiantly swoops up Vinnie in his arms and carries them to safety."
                    ...
                    "I hear loud chewing noises and distant screaming as I run away."
            ...
            "I headbutt the zombie attacking Vinnie with my horns!" if sage_has_gun == False:
                ...
                show orangzom at offscreen_bottom with move
                hide orangzom
                "I was able to clear a path for Vinnie, but got hurt in the process when the zombie slashed my head!" with hpunch
                if sage_health == 0:
                    jump death_screen
            ...
            "I crowbar the zombies attacking Vinnie!" if rocky_dead == True:
                ...
                $ renpy.notify("Crowbar has been removed from your inventory!")
                $ crowbar_collected = False
                "I successfully made an opening for Vinnie as they ran, but lost the crowbar in the process!"
            ...
            "I tell Rocky to save Vinnie!" if rocky_dead == False:
                ...
                if expose_samsara_together == False and crowbar_collected == True:
                    ...
                    $ renpy.notify("Crowbar has been removed from your inventory!")
                    $ crowbar_collected = False
                    "Rocky lunges at the zombies and gets injured! He loses the crowbar to the horde!"
                    show orangzom at offscreen_bottom with move
                    hide orangzom
        ...
        if expose_samsara_together == True:
            ...
            menu:
                ...
                "I tell Vinnie to save Rocky" if vinnie_dead == False and vinnies_knife == False:
                    ...
                    hide v 
                    "Vinnie charges forward, but gets their body ravaged by the zombies in return!"
                ...
                "I tell Vinnie to stab the zombies" if vinnie_dead == False and vinnies_knife == True:
                    ...
                    $ renpy.notify("Vinnie's Knife has been removed from your inventory!")
                    $ vinnies_knife = False
                    "Vinnie charges forward and stabs the zombies! The knife is lost in it's head!"
                    show r 2 at hop
                ...
                "I tell Vinnie to shoot the zombies!" if vinnie_dead == False and ammo >= 1 and vinnie_has_gun == True:
                    ...
                    "Vinnie panics and shoots wildly. They don't hear the zombie behind them and get hurt as a result"
                ...
                "I knock the zombie's block off!":
                    ...
                    show dunce at offscreen_bottom with move
                    hide dunce
                    "I was able to save Rocky, but got my fists banged up by the zombies as a result!"
                    show r 10 at hop
                    r "Thanks, [pov]!"
                ...
                "I run away and abandon Rocky!":
                    if vinnie_dead == False and vinnie_has_gun == True:
                        ...
                        if vinnie_health == 0:
                            ...
                            "Vinnie panics and shoots wildly.{w=.3} They didn't hear the zombies behind them and get hurt as a result!"
                            v "*huff*{w=.3} *huff*{w=.3} I JUST SAVED YOUR ASS I EXPECT TO GET THE HOLIEST SLOPPY IN RETURN FOR THIS!!!"   
                        ...
                        $ renpy.notify("Vinnie's Knife has been removed from your inventory!")
                        $ vinnies_knife = False
                        "Vinnie charges forward and stabs the zombies!{w=.3} They get hurt in return and the knife is lost in the zombie's head!"
                        $ addVinhealth(-2)
                        show v 2 1 at left
                        if vinnie_health == 0:
                            $ vinnie_dead = True
                        ...
                        "Vinnie charges forward and gets lost in the horde as a result..."
                        "I hear chewing noises before Rocky yanks Vinnie out of there and cradles them in his arms..."
                        show r 8 at hop
                        r "VINNIE NO!!! ARE YOU OK! SPEAK TO ME!! YOU'RE NOT DEAD! YOU'RE NOT!!!!"
                        show v 2 1 at offscreen_bottom with move
                        show r 8 at sink
                        v "I... {w=.3}Really... {w=.3}l- {w=.3}l-{w=.3} Liked our time together...{w=.3} Please don-{w=.3}t... {w=.3}Worry...{w=.3} Hahahaaa... {w=.3}*cough*"
                        ...
                        show r 7 at shiver
                        "Vinnie uses the last of their strength to shove Rocky away and gestures for him to run to the elevator."
                        "Rocky hesitates for a long second, but eventually does so."
                        show r 7 at shiver
                        pause 0.5
                        ...
                        camera:
                            reset
                        r "OH YEAH?!?! I-{w=.3}I'LL BEAT YOU ALL TO DEATH JUST YOU WAT-{w=.2} ARGGGHHHHH!!!"
                        ...
                        hide r 2a 
                        "I hear chewing noises as I run away..."
    else:
        pass
    ...
    if vinnie_health == 0:
        $ vinnie_dead = True
        "Vinnie is down and isn't getting back up..."
